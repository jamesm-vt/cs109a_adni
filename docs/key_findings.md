...
<figure class="center_fig">
    <img src="/docs/data_summary_files/modelheatmap.png" style="width: 80%; color:white" class="image">
...
<figure class="center_fig">
    <img src="/docs/data_summary_files/VennDiagram_topFeatures.svg" style="width: 80%" class="image">
    <figcaption class="center_cap" style="text-align: center">
        Figure 2. Top Features Found by Each Ensemble Model.
    </figcaption>
</figure>
...
Based on the agreeement of the top features generated by Adaboost, Bagging and Random Forest (Figure 2), we removed logistic regression from further analysis. Furthermore, we wanted to place an additional emphasis on non-obvious features for AD predictability. Hence among the three, we settled on random forest because it considers a different subset of all features in each estimator used for training and its performance metrics are comparable to the top performing model (Figure 1). 

<figure class="center_fig">
    <img src="/docs/data_summary_files/FeatureImportance_top80.png" class="image">
    <figcaption class="center_cap" style="text-align: center">
        Figure 3. Top Features arranged by Feature Importance as assigned by Random Forest.
    </figcaption>
</figure>
...
<figure class="center_fig">
    <img src="/docs/data_summary_files/feat_import_model.png" class="image" style="width: 100%">
    <figcaption class="center_cap" style="text-align: center">
        Figure 4. Impact of model choice on feature importance.
    </figcaption>
</figure>


<figure class="center_fig">
    <img src="/docs/data_summary_files/missingness_Vs_Importance.svg" class="image">
    <figcaption class="center_cap" style="text-align: center">
        Figure 5. Percentage of data imputed among our top 80 common features across three ensemble models.
    </figcaption>
</figure>
