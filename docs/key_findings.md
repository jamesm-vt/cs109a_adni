...
<figure class="center_fig">
    <img src="/cs109a_adni/data_summary_files/VennDiagram_topFeatures.svg" style="width: 80%" class="image">
    <figcaption class="center_cap" style="text-align: center">
...
<figure class="center_fig">
    <img src="/cs109a_adni/data_summary_files/FeatureImportance_top80Features.png" class="image">
    <figcaption class="center_cap" style="text-align: center">
