...
<figure class="center_fig">
    <img src="/cs109a_adni/data_summary_files/age_edu_demo.svg" class="image">
    <figcaption class="center_cap">
        Figure 3. Distributions of ADNI patient age and education level.
    </figcaption>
</figure>
<figure class="center_fig">
    <img src="/cs109a_adni/data_summary_files/racial_demo.svg" class="image">
    <figcaption class="center_cap">
        Figure 4. Distributions of ADNI patient racial and ethnic demographics.
    </figcaption>
</figure>
...
<figure class="center_fig">
    <img src="/cs109a_adni/data_summary_files/missingness_hist.svg" class="image">
    <figcaption class="center_cap">
...
<figure class="center_fig">
    <img src="/cs109a_adni/data_summary_files/adni_merge_missingness.png" class="image" style="width: 85%">
    <figcaption class="center_cap">
